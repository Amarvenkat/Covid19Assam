...
import com.amar.covid19assam.Adapters.MainRecyclerAdapter;
import com.amar.covid19assam.CollectionFood.CollectionFoodMain;
import com.amar.covid19assam.HealthWorkerAssigning.HealthWorkerAssigning;
import com.amar.covid19assam.MigrantLabour.LabourDetails;
import com.amar.covid19assam.Orphan.OrphanHome;
import com.amar.covid19assam.Unorganizedworker.UnorganizedMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        travelcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://eservices.assam.gov.in/renderApplicationForm.do;jsessionid=41A737E21AD3722BA7D514C9F2622E5F?serviceId=15330010&UUID=ec93f2fe-d0f5-4ef8-8777-4a10cec27c6e&grievDefined=0&serviceLinkRequired=No&directService=true&userLoggedIn=N&tempId=5969&source=CTZN&OWASP_CSRFTOKEN=23H7-08MG-UAHB-583P-TC8B-NPKZ-21DH-INAQ"));
