...
import com.amar.covid19assam.ApiInterface.ApiDistrictData;
import com.amar.covid19assam.Apiclients.ApiClient;
import com.amar.covid19assam.DistricRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<TelanganaStateWise>() {
            ...
            public void onResponse(Response<TelanganaStateWise> response) {
                ...
                Integer southSalmaraMankacharactive = result.getDistricData().getSouthSalmaraMankachar().getSouthSalmaraMankachaactive();
                Integer tinsukiaactive = result.getDistricData().getTinsukia().getTinsukiaactive();
                Integer udalguriactive = result.getDistricData().getUdalguri().getUdalguriactive();
                Integer westKarbiAnglongactive = result.getDistricData().getWestKarbiAnglong().getWestKarbiAnglongactive();
                ...
                Integer southSalmaraMankacharconfirmed = result.getDistricData().getSouthSalmaraMankachar().getSouthSalmaraMankachaconfirmed();
                Integer tinsukiaconfirmed = result.getDistricData().getTinsukia().getTinsukiaconfirmed();
                Integer udalguriconfirmed = result.getDistricData().getUdalguri().getUdalguriconfirmed();
                Integer westKarbiAnglongconfirmed = result.getDistricData().getWestKarbiAnglong().getWestKarbiAnglongconfirmed();
                ...
                Integer southSalmaraMankachardeceased = result.getDistricData().getSouthSalmaraMankachar().getSouthSalmaraMankachadeceased();
                Integer tinsukiadeceased = result.getDistricData().getTinsukia().getTinsukiadeceased();
                Integer udalgurideceased = result.getDistricData().getUdalguri().getUdalgurideceased();
                Integer westKarbiAnglongdeceased = result.getDistricData().getWestKarbiAnglong().getWestKarbiAnglongdeceased();
                ...
                Integer southSalmaraMankacharrecovered = result.getDistricData().getSouthSalmaraMankachar().getSouthSalmaraMankacharecovered();
                Integer tinsukiarecovered = result.getDistricData().getTinsukia().getTinsukiarecovered();
                Integer udalgurirecovered = result.getDistricData().getUdalguri().getUdalgurirecovered();
                Integer westKarbiAnglongrecovered = result.getDistricData().getWestKarbiAnglong().getWestKarbiAnglongrecovered();
                ...
                districname.add(R.string.southSalmaraMankachar);
                districname.add(R.string.tinsukia);
                districname.add(R.string.udalguri);
                districname.add(R.string.westKarbiAnglong);
                ...
                districactive.add(southSalmaraMankacharactive);
                districactive.add(tinsukiaactive);
                districactive.add(udalguriactive);
                districactive.add(westKarbiAnglongactive);
                ...
                districconfirmed.add(southSalmaraMankacharconfirmed);
                districconfirmed.add(tinsukiaconfirmed);
                districconfirmed.add(udalguriconfirmed);
                districconfirmed.add(westKarbiAnglongconfirmed);
                ...
                districdeceased.add(southSalmaraMankachardeceased);
                districdeceased.add(tinsukiadeceased);
                districdeceased.add(udalgurideceased);
                districdeceased.add(westKarbiAnglongdeceased);
                ...
                districrecovered.add(southSalmaraMankacharrecovered);
                districrecovered.add(tinsukiarecovered);
                districrecovered.add(udalgurirecovered);
                districrecovered.add(westKarbiAnglongrecovered);
